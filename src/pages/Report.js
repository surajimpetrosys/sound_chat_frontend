...
import { UserListHead, UserListToolbar, InterviewMoreMenu,QueryMoreMenu } from '../components/_dashboard/user';
//
...
const TABLE_HEAD = [
    { id: 'report_id', label: 'Query No.', alignRight: false },
    ...
    { id: 'report_status', label: 'Query Status', alignRight: false },
...
export default function Report() {
  ...
  const handleClose = () => {
    ...
    useEffect(() => {
        const Livechaturl = `http://3.23.210.57:3000/api/v1/auth/listreport`;
                                ...
                                <TableBody>
                                    {finalArray
                                        ...
                                        .map((row) => {
                                            ...
                                            const isItemSelected = selected.indexOf(report_id) !== -1;
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <TableCell align="left">{report_id}</TableCell>
                                                    ...
                                                    {(report_status==='0')?<><TableCell align="left">In Touch</TableCell></>:<><TableCell align="left">Replied</TableCell></>}
