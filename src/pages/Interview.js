...
import { UserListHead, UserListToolbar, InterviewMoreMenu } from '../components/_dashboard/user';
//
...
export default function Interview() {
  ...
  const handleClose = () => {
    ...
    useEffect(() => {
        const Livechaturl = `http://3.23.210.57:3000/api/v1/auth/interviews`;
        const bodyFormData = new FormData();
        axios.post(Livechaturl, bodyFormData, { 'Content-Type': 'multipart/form-data' })
            .then((response) => {
                const outlook = response
                setPremiumContent(outlook.data.data.premium_content);
                setfreeContent(outlook.data.data.free_content);
            })
    }, []);
    ...
    return (
        <Page title="Interview | SoundChatRadio">
            <Container>
                                        ...
                                        .map((row) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <TableCell align="left">{interview_type}</TableCell>
