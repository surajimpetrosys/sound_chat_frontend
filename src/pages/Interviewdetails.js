...
const InterviewDetails = (props) => {
  ...
  return (
<Page title="Interview details | SoundChatRadio">
                    ...
                    <Card>
                      ...
                      <CardContent>
                        <ul className="list-group-left">
                          ...
                          <li className="list-group-item list-group-item-primary">Interview Type</li>
                        ...
                        <ul className="list-group-right">
                          <li className="list-group-item list-group-item-primary">{gallery.post_title}</li>
                          <li className="list-group-item list-group-item-primary">{gallery.post_content}</li>
                          <li className="list-group-item list-group-item-primary">{gallery.video_url}</li>
                          <li className="list-group-item list-group-item-primary">{gallery.content_type}</li>
                          {/* <li className="list-group-item list-group-item-primary">{gallery.post_content}</li> */}
                          <li className="list-group-item list-group-item-primary">{gallery.interview_type}</li>
                        ...
                        <Grid container spacing={3}>
                          ...
                          <Grid item xs={12} md={6} lg={6}>
                            ...
                            >
                              ...
                              <CoverImgStyle alt={gallery.feature_img} src={baseurl + gallery.feature_img} />
                          ...
                          <Grid item xs={12} md={6} lg={6}>
                            ...
                            <CardMediaStyle className="upload-img"
                              sx={{
                                ...((gallery.feature_img || gallery.feature_img) && {
                                  // pt: 'calc(100% * 4 / 3)',
                                  '&:after': {
