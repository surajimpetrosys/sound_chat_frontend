...
import { UserListHead, UserListToolbar, LiveContentMoreMenu } from '../components/_dashboard/user';
//
...
const TABLE_HEAD = [
    ...
    { id: 'content_type', label: 'Content Type', alignRight: false },
    { id: 'livelink', label: 'Live link ', alignRight: false },
...
export default function Events() {
  ...
  if(localStorage.getItem('token')==='llll'){
    ...
    useEffect(() => {
        const Livechaturl = `http://3.23.210.57:3000/api/v1/auth/listlivecontent`;
    ...
    const handleSelectAllClick = (event) => {
        if (event.target.checked) {
            const newSelecteds = premiumContent.map((n) => n.id);
    ...
    return (
        <Page title="Live Content | SoundChatRadio">
            <Container>
                                        ...
                                        .map((row) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <TableCell align="left">{content_type}</TableCell>
                                                    <TableCell align="left">{livelink}</TableCell>
                                                    <TableCell align="left">{moment(updatedAt).format('MMMM Do YYYY')}</TableCell>

                                                    <TableCell align="right">
                                                        <LiveContentMoreMenu id={id}/>
                                                    </TableCell>
                                                </TableRow>
                                            );
                                        })}
