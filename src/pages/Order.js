...
const TABLE_HEAD = [
    ...
    { id: 'transaction_status', label: 'Transaction Status', alignRight: false },
    { id: 'order_status', label: 'Order Status', alignRight: false },
    { id: 'updatedat', label: 'Order Date', alignRight: false },
    { id: '' }
]
// ----------------------------------------------------------------------
...
export default function Order() {
  ...
  const handleClose = () => {
    ...
    useEffect(() => {
        const Livechaturl = `http://3.23.210.57:3000/api/v1/auth/listallOrder`;
    ...
    return (
        <Page title="Product Order | SoundChatRadio">
            <Container>
                                        ...
                                        .map((row) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <TableCell align="left">{transaction_status}</TableCell>
                                                    <TableCell align="left">{order_status}</TableCell>
