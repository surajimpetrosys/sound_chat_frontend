...
const ProductDetails = (props) => {
  ...
  const deleterow = ()=>{
    const Livechaturl = `http://3.23.210.57:3000/api/v1/auth/deleteproduct`;
                    ...
                    <Card>
                      ...
                      <CardContent>
                        ...
                        <ul className="list-group-right">
                          ...
                          <li className="list-group-item list-group-item-primary">{gallery.description}</li>
                          <li className="list-group-item list-group-item-primary">{gallery.SKU}</li>
                          <li className="list-group-item list-group-item-primary">{gallery.catogery}</li>
                          ...
                          <li className="list-group-item list-group-item-primary">{gallery.Price}</li>
                          <li className="list-group-item list-group-item-primary">{gallery.currency}</li>
                        ...
                        <Grid container spacing={3}>
                          ...
                          <Grid item xs={12} md={6} lg={6}>
                            ...
                            >
                              ...
                              <CoverImgStyle alt={gallery.image} src={baseurl + gallery.image} />
