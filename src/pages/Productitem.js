...
import { UserListHead, UserListToolbar, ProductitemMoreMenu } from '../components/_dashboard/user';
//
...
const TABLE_HEAD = [
    ...
    { id: 'Avaibility', label: 'Avaibility', alignRight: false },
...
export default function Productitem(props) {
  ...
  const handleClose = () => {
    ...
    axios.post(Livechaturl, { id: props.props }, { 'Content-Type': 'multipart/form-data' })
      .then((response) => {
        const outlook = response
        setPremiumContent(outlook.data.data.productavailabilities);
    ...
    return (
        <Page title="Product Item/Size list | SoundChatRadio">
            <Container>
                <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
                    <Typography variant="h4" gutterBottom>
                        Product Size-Color-Quantity-Avaibility List
          </Typography>
                    <Button
                        variant="contained"
                        component={RouterLink}
                        to={`/dashboard/products/details/addproductavaibility/${props.props}`}
                        startIcon={<Icon icon={plusFill} />}
                    > Add Product Size/color/quantity/avaibility    
          </Button>
                </Stack>
                    ...
                    <Scrollbar>
                        <TableContainer sx={{ minWidth: 800 }}>
                            <Table>
                                ...
                                />
                                <TableBody>
                                    {premiumContent.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)
                                        .map((row) => {
                                            const { 
                                                createdAt,
                                                quantity,
                                                ...
                                                >
                                                    ...
                                                    <TableCell component="th" scope="row" padding="none">
                                                        <Stack direction="row" alignItems="center" spacing={2}>
                                                            <Avatar variant="square" alt={Image} src={baseurl+Image} />
                                                        </Stack>
                                                        </TableCell>
                                                        {/* <TableCell component="th" scope="row" padding="none">
                                                        <Stack direction="row" alignItems="center" spacing={2}>
                                                    ...
                                                    <TableCell align="center">
                                                        <ProductitemMoreMenu id={[id_product,id]}/>
                                                    </TableCell>
                                                </TableRow>
                                            );
                                        })}
