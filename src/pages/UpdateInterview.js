...
export default function UpdateInterview(props) {
    ...
    const formik = useFormik({
        ...
        onSubmit: () => {
            ...
            bodyFormData.append('interview_id', params.interviewId);
    ...
    useEffect(() => {
        ...
        axios.post(Livechaturl, { interview_id: params.interviewId }, { 'Content-Type': 'multipart/form-data' })
            .then((response) => {
                ...
                setinterview_type(outlook.data.data.interview_type)
                setposter(outlook.data.data.feature_img)
            ...
            <Container>
                ...
                <FormikProvider value={formik}>
                    <Form autoComplete="off" noValidate onSubmit={handleSubmit}>
                                        ...
                                        <Grid container spacing={3}>
                                            ...
                                            <Grid item xs={12} md={12} lg={12}>
                                                <Stack spacing={3}>
                                                    <FormControl>
                                                        <InputLabel shrink htmlFor="circle">
                                                            Interview Description</InputLabel>
                                                        <TextField
                                                            fullWidth
                        ...
                        {/* {(mobileimage) ? <Grid item xs={12} md={12} lg={12} sx={{ mt: 3 }}>
                            <Card>
