...
const AddForm = () => {
  ...
  const onSubmit = data => {
    ...
    bodyFormData.append('post_title', data.post_title);
    bodyFormData.append('post_excerpt', data.post_excerpt);
    bodyFormData.append('post_name', data.post_name);
    bodyFormData.append('post_type', data.post_type);
    bodyFormData.append('video_url', data.video_url);
    bodyFormData.append('content_type', data.content_type.value);
    bodyFormData.append('interview_type', data.interview_type.value);
  ...
  return (
    <form className={classes.root} onSubmit={handleSubmit(onSubmit)}>
      ...
      <Controller
        ...
        rules={{ required: 'post name required' }}
      />
      <Controller
        name="post_type"
        control={control}
      ...
      <Controller
        ...
        rules={{ required: 'video url required' }}
      />
      {/* <Controller
        name="content_type"
        control={control}
      ...
      <Controller
        ...
        render={({ field }) => <Select
          {...field} 
          options={[
            { value: "premium_content", label: "PAID" },
            { value: "free_content", label: "FREE" },
          ]} 
        />}
        rules={{ required: 'content type is required' }}
      />
       {/* <Controller
        ...
        rules={{ required: 'interview type required' }}
      /> */}
      <Controller
        name="interview_type"
        label = 'interview type'
        ...
        render={({ field }) => <Select 
          {...field} 
          options={[
            { value: "YELLOW-TENT", label: "YELLOW-TENT" },
      ...
      <Stack direction={{ xs: 'row', sm: 'row',md:'row',lg:'row' }} spacing={4}>
