...
const EditFormInterview = (props) => {
  ...
  const onSubmit = data => {
    ...
    bodyFormData.append('interview_id', props.id);
    ...
    bodyFormData.append('interview_type', data.interview_type);
    const Livechaturl = `http://3.23.210.57:3000/api/v1/auth/interviewsupdate`;
...
export default EditFormInterview;