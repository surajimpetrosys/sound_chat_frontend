...
export default function ShowMoreMenu(props) {
  ...
  return (
    <>
      ...
      >
        <MenuItem component={RouterNavLink} to={`/dashboard/shows/updateshow/${props.id}`}  sx={{ color: 'text.secondary' }}>
          <ListItemIcon>
            <Icon icon={editFill} width={24} height={24} onClick={handleClickOpen} />
          </ListItemIcon>
        </MenuItem>
        <MenuItem component={RouterNavLink} to={`/dashboard/shows/showslist/${props.id}`}  sx={{ color: 'text.secondary' }}>
          <ListItemIcon>
