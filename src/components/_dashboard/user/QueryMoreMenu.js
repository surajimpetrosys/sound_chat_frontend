...
export default function QueryMoreMenu(props) {
  ...
  const deleterow = ()=>{
    const Livechaturl = `http://3.23.210.57:3000/api/v1/auth/deletereport`;
  ...
  return (
    <>
      ...
      >
        ...
        <MenuItem component={RouterNavLink} to={`/dashboard/query/details/${props.id}`}  sx={{ color: 'text.secondary' }}>
          <ListItemIcon>
