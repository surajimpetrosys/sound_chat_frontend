...
// ----------------------------------------------------------------------
import { EditFormBanner } from '../../Forms/index';
...
export default function BannerMoreMenu(props) {
  ...
  const deleterow = ()=>{
    const Livechaturl = `http://3.23.210.57:3000/api/v1/auth/deletebanner`;
  ...
  return (
    <>
      ...
      >
        <MenuItem component={RouterNavLink} to={`/dashboard/banner/updatebanner/${props.id}`}  sx={{ color: 'text.secondary' }}>
          <ListItemIcon>
            <Icon icon={editFill} />
          </ListItemIcon>
        </MenuItem>
