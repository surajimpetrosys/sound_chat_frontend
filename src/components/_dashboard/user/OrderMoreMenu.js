  ...
  return (
    <>
      ...
      >
        ...
        {/* <MenuItem component={RouterNavLink} to={`/dashboard/productorder/update/${props.id}`}  sx={{ color: 'text.secondary' }}>
          <ListItemIcon>
            <Icon icon={editFill} width={24} height={24} onClick={handleClickOpen} />
          </ListItemIcon>
        </MenuItem> */}
        <MenuItem component={RouterNavLink} to={`/dashboard/productorder/details/${props.id}`}  sx={{ color: 'text.secondary' }}>
          <ListItemIcon>
